...
#GENERATING FEATURE COUNTS AS ONE SINGLE REPORT FOR ALL THE SAMPLES
#mkdir FEATURE_ONE
#featureCounts -T 20 -a /home/fkakembo/Bioinformatics/RNASeq_MiniProject/References/Homo_sapiens.GRCh38.100.gtf  \
 #       -o  FEATURE_ONE/feature_counts.txt \
  #     Bam/sample{37..42}.sorted.bam

#cut -f1,7,8,9,10,11,12 FEATURE_ONE/feature_counts.txt > FEATURE_ONE/counts1.Rmatrix.txt 
